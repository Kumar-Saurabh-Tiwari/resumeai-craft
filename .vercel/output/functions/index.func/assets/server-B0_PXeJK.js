...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BHwTTeyh.js");
...
const manifest = {
  "f495b47df060a8838d9eaaa48cd232f2439f54f94bae34b286953a90eae849fc": {
    functionName: "analyzeResume_createServerFn_handler",
    importer: () => import("./analyze.functions-DrLbZONt.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-5h8OAYat.js"),
    import("./start-Ayd6mn72.js"),
